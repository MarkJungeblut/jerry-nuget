...
Reusable xUnit fixtures for testing gRPC services without duplicating server setup code.
...
## ExceptionLoggingTestFixture

A specialized fixture that extends `GrpcServerFixture` with pre-configured exception logging interceptor and mock logger.

See [ExceptionLoggingTestFixture.cs](ExceptionLoggingTestFixture.cs) for implementation details.
